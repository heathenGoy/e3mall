...
<body>
	...
	<div id="index_layout">
		...
		<div data-options="region:'center'" title="欢迎使用E3" style="overflow: hidden;">
			<div id="index_tabs" style="overflow: hidden;">
				<div title="首页" data-options="border:false" style="overflow: hidden;">
					<iframe src="${pageContext.request.contextPath}/portal/index.jsp?v=ssss" frameborder="0" style="border: 0; width: 100%; height: 98%;"></iframe>
				</div>
			</div>
		</div>
