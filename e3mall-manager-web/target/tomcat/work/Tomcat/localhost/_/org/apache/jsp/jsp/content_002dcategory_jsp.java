 ...
 * Generated at: 2017-11-12 09:42:40 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t//获取整颗树dom对象\r\n");
      out.write("\tvar tree = $(\"#contentCategory\");\r\n");
      out.write("\t//获取树形节点选中节点对象\r\n");
      out.write("\tvar node = tree.tree(\"getSelected\");\r\n");
      out.write("\t//如果传递参数是add,表示是添加节点\r\n");
      out.write("\tif(item.name === \"add\"){\r\n");
      out.write("\t\t//调用EasyUI 的 append方法添加节点\r\n");
      ...
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("\t\t//获取新添加节点dom对象\r\n");
      out.write("\t\tvar _node = tree.tree('find',0);\r\n");
      out.write("\t\t//开始编辑，鼠标离开，触发事件onAfterEdit\r\n");
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t//var nodes = $('#tt').tree('getChecked', 'indeterminate');\r\n");
      out.write("\t\t\t\tvar parent_Node = tree.tree(\"getParent\",node.target);\r\n");
      out.write("\t\t\t\t$.post(\"/content/category/delete/\",{parentId:parent_Node.id,id:node.id},function(){\r\n");
